...
function addStyleFromDraftInlineStyle(styleSet, element) {
  if (!element.style) {
    return styleSet;
  }

  if (element.style.fontWeight === 'bold') {
    styleSet = styleSet.add(_draftJsUtils.INLINE_STYLE.BOLD);
  }

  if (element.style.fontStyle === 'italic') {
    styleSet = styleSet.add(_draftJsUtils.INLINE_STYLE.ITALIC);
  }

  if (element.style.textDecoration === 'underline') {
    styleSet = styleSet.add(_draftJsUtils.INLINE_STYLE.UNDERLINE);
  }

  if (element.style.textDecoration === 'line-through') {
    styleSet = styleSet.add(_draftJsUtils.INLINE_STYLE.STRIKETHROUGH);
  }

  return styleSet;
}

function removeStyleFromDraftInlineStyle(element) {
  if (!element.style) {
    return element;
  }
